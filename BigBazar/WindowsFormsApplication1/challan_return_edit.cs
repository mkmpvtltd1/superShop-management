...
namespace WindowsFormsApplication1
{
    public partial class challan_return_edit : Form
    {
        ...
        private void challan_return_edit_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string q = "select itemCode,itemName,quantity,unitPrice,pPrice from challanReturn where cdate='" + comboBox1.Text + "' and challanNo='" + comboBox2.Text + "';";
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string q = "select DISTINCT challanNo from challanReturn where cDate='" + comboBox1.Text + "' ;";
            SqlCommand cmd = new SqlCommand(q, aa);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "execute updateChallanReturn @quan,@unitP,@challanNO,@date,@itemC";
                cmd.Parameters.AddWithValue("@quan", quan);
                cmd.Parameters.AddWithValue("@unitP", unitp);
                cmd.Parameters.AddWithValue("@challanNO", comboBox2.Text);
        ...
        {
            string q = "delete from challanReturn where challanNo='" + comboBox2.Text + "' and cdate='" + comboBox1.Text + "' and itemCode='" + textBox2.Text + "';";
            SqlCommand cmd = aa.CreateCommand();
            cmd.CommandText = q;
            try
            {
